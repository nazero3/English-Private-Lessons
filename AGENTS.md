...
- Prefer quiet, simple UI: fewer extra tabs and buttons, especially on manager dashboards; teacher hour entry should be easy with little repetition.
...
- Live production is https://kinz-teach.cloud/; GitHub Actions deploys on push to `main`.
...
- Students are first-class records, not free-text labels.
