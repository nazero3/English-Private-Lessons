  ...
  "9": [
    ...
    },
    {
      ...
      quiz: [
        {
          q: "Planned action:",
          options: ["I will maybe go.", "I am going to study tonight.", "I go study."],
          correct: 1,
        },
        {
          q: "Instant decision:",
          options: ["I am going to answer it.", "I will answer it.", "I answering."],
          correct: 1,
        },
        {
      ...
      quiz: [
        {
          ...
          options: ["You are opening the door.", "Open the door.", "He opens the door."],
          correct: 1,
        },
        {
    ...
    },
    {
      ...
      quiz: [
        ...
        {
          q: "Correct sentence:",
          options: ["He had went home.", "He had gone home.", "He has gone home yesterday."],
          correct: 1,
        },
        {
      ...
      quiz: [
        {
          ...
          options: ["I wish I am rich.", "I wish I were rich.", "I wish I will be rich."],
          correct: 1,
        },
        {
          q: "Use with ability:",
    ...
    },
    {
      ...
      quiz: [
        ...
        {
          q: "Correct sentence:",
          options: ["The man which helped me.", "The man who helped me.", "The man where helped me."],
          correct: 1,
        },
        {
      ...
      quiz: [
        {
          ...
          options: ["He asked if I studied.", "He asked if did I study.", "He asked I studied?"],
          correct: 0,
        },
        {
    ...
    },
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ["A bridge built.", "A bridge was built.", "A bridge is builded."],
          correct: 1,
        },
        {
  ...
  "12": [
    {
      ...
      visual: [["Present", "I study medicine."], ["Past", "I studied hard last year."]],
      exercises: [
      ...
      quiz: [
        { q: "Past form of choose:", options: ["choosed", "chose", "choosen"], correct: 1 },
        { q: "Present habit:", options: ["I am study", "I study daily", "I studied now"], correct: 1 },
        { q: "Now action:", options: ["is studying", "studies", "studied"], correct: 0 },
      ],
    },
    {
      unit: 2,
      ...
      visual: [["Present perfect", "I have achieved my goal."], ["Past continuous", "I was working late."]],
      exercises: [
      ...
      quiz: [
        { q: "Correct:", options: ["He have won.", "He has won.", "He is won."], correct: 1 },
        { q: "Interrupted past action:", options: ["was reading", "has read", "reads"], correct: 0 },
        { q: "Already usually with:", options: ["present perfect", "future perfect", "imperative"], correct: 0 },
      ],
    },
    {
      unit: 3,
      ...
      visual: [["Active", "Doctors treat patients."], ["Passive", "Patients are treated."]],
      exercises: [
      ...
      quiz: [
        { q: "Passive form:", options: ["be + V3", "do + V1", "have + V3"], correct: 0 },
        { q: "Past passive:", options: ["was treated", "is treated", "has treated"], correct: 0 },
        { q: "Scientific writing prefers:", options: ["passive", "imperatives", "slang"], correct: 0 },
      ],
    },
    {
      unit: 4,
      ...
      visual: [["Have", "I had my laptop repaired."], ["Get", "She got her phone fixed."]],
      exercises: [
      ...
      quiz: [
        { q: "Causative example:", options: ["I repaired my car.", "I had my car repaired.", "My car repaired."], correct: 1 },
        { q: "Common verbs in causative:", options: ["have/get", "be/do", "can/must"], correct: 0 },
        { q: "She got her glasses ____.", options: ["repair", "repaired", "repairs"], correct: 1 },
      ],
    },
    {
      unit: 5,
      ...
      visual: [["Defining", "Citizens who vote shape policy."], ["Non-defining", "The UN, which was founded in 1945, ..."]],
      exercises: [
      ...
      quiz: [
        { q: "For things:", options: ["who", "which/that", "whose only"], correct: 1 },
        { q: "For people:", options: ["who", "which", "where"], correct: 0 },
        { q: "Clause adds info about noun?", options: ["Relative clause", "Imperative", "Modal"], correct: 0 },
      ],
    },
    {
      unit: 6,
      ...
      visual: [["Plan", "We are meeting tomorrow."], ["Prediction", "This policy will help students."]],
      exercises: [
        { q: "The meeting ____ at 9 tomorrow (fixed).", a: "starts" },
        { q: "I think it ____ improve education.", a: "will" },
        { q: "We ____ visit the center next week (planned).", a: "are going to" },
      ],
      quiz: [
        { q: "Timetable future:", options: ["present simple", "past simple", "wish"], correct: 0 },
        { q: "Prediction:", options: ["will", "had", "did"], correct: 0 },
        { q: "Planned intention:", options: ["going to", "was", "has"], correct: 0 },
      ],
    },
    {
      unit: 7,
      ...
      visual: [["Type II", "If I were a scientist, I would research viruses."], ["Type III", "If we had acted earlier, we would have saved time."]],
      exercises: [
      ...
      quiz: [
        { q: "Type III pattern:", options: ["if + past perfect", "if + present simple", "if + infinitive"], correct: 0 },
        { q: "Type II uses:", options: ["real facts", "unreal present/future", "commands"], correct: 1 },
        { q: "If he had left early, he ____ the bus.", options: ["would catch", "would have caught", "catches"], correct: 1 },
      ],
    },
    {
      unit: 8,
      ...
      visual: [["Present wish", "I wish I were healthier."], ["Past regret", "I wish I had slept earlier."]],
      exercises: [
      ...
      quiz: [
        { q: "Present unreal wish:", options: ["wish + past simple", "wish + present simple", "wish + will"], correct: 0 },
        { q: "Past regret:", options: ["wish + had + V3", "wish + V1", "wish + am"], correct: 0 },
        { q: "He wishes he ____ drive.", options: ["could", "can", "is"], correct: 0 },
      ],
    },
    {
      unit: 9,
      ...
      visual: [["Balance", "Both rights and duties matter."], ["Emphasis", "Not only citizens but also schools must act."]],
      exercises: [
      ...
      quiz: [
        { q: "Negative pair:", options: ["both...and", "neither...nor", "either...or"], correct: 1 },
        { q: "Choice pair:", options: ["either...or", "not only...but also", "both...and"], correct: 0 },
        { q: "Add emphasis:", options: ["not only...but also", "if...then", "because"], correct: 0 },
      ],
    },
    {
      unit: 10,
      ...
      visual: [["Advice", "You should respect local customs."], ["Obligation", "Visitors must follow rules."]],
      exercises: [
      ...
      quiz: [
        { q: "Strong obligation:", options: ["must", "might", "could"], correct: 0 },
        { q: "Polite permission:", options: ["may", "must", "should"], correct: 0 },
        { q: "Might expresses:", options: ["certainty", "possibility", "past regret"], correct: 1 },
      ],
    },
    {
      unit: 11,
      ...
      visual: [["Direct", "She said, 'AI helps doctors.'"], ["Reported", "She said that AI helped doctors."]],
      exercises: [
      ...
      quiz: [
        { q: "Reported speech often uses:", options: ["that-clause", "imperative only", "question marks"], correct: 0 },
        { q: "Direct: 'I am happy.' => He said he ____ happy.", options: ["is", "was", "be"], correct: 1 },
        { q: "Backshift from will:", options: ["would", "shall", "can"], correct: 0 },
      ],
    },
    {
      unit: 12,
      ...
      visual: [["Normal", "I have never seen such speed."], ["Inversion", "Never have I seen such speed."]],
      exercises: [
      ...
      quiz: [
        { q: "Inversion is common in:", options: ["formal emphasis", "basic greetings", "commands"], correct: 0 },
        { q: "Correct inversion:", options: ["Never I have seen", "Never have I seen", "Never seen I have"], correct: 1 },
        { q: "Rarely ____ we find such data.", options: ["do", "does", "did"], correct: 0 },
      ],
    },
  ],
};
...
const unitTheme = document.getElementById("unitTheme");
const unitGrammar = document.getElementById("unitGrammar");
const unitArabic = document.getElementById("unitArabic");
...
function renderUnitList() {
  unitList.innerHTML = "";
  DATA[currentGrade].forEach((unit, index) => {
    const btn = document.createElement("button");
    btn.className = `unit-btn ${index === currentUnitIndex ? "active" : ""}`;
    btn.textContent = `Unit ${unit.unit}: ${unit.theme}`;
...
function renderVisual(unit) {
  const rows = unit.visual
    .map(
      (item) =>
        `<div class="visual-box"><strong>${item[0]}</strong><br />${item[1]}</div>`
    )
    .join("");
  visualArea.innerHTML = `<div class="visual-row">${rows}</div>`;
}

function renderExercises(unit) {
  exerciseArea.innerHTML = "";
  unit.exercises.forEach((exercise, idx) => {
    const wrapper = document.createElement("div");
    wrapper.className = "exercise-item";
    wrapper.innerHTML = `
      <p><strong>${idx + 1}.</strong> ${exercise.q}</p>
      <input type="text" id="ex-${idx}" placeholder="Type your answer" />
    `;
  ...
  unit.quiz.forEach((q, qIdx) => {
    ...
    const options = q.options
      ...
      <label class="quiz-option">
        <input type="radio" name="quiz-${qIdx}" value="${optIdx}" />
        ${opt}
      </label>
    `
      )
      .join("");
    wrapper.innerHTML = `<p><strong>${qIdx + 1}.</strong> ${q.q}</p>${options}`;
...
function renderAll() {
  renderUnitList();
  const unit = DATA[currentGrade][currentUnitIndex];
  unitTitle.textContent = `Grade ${currentGrade} - Unit ${unit.unit}`;
  unitTheme.textContent = unit.theme;
  unitGrammar.textContent = unit.grammar;
  unitArabic.textContent = unit.arabic;
  explanationText.textContent = unit.explanation;
  renderVisual(unit);
...
function checkExercises() {
  ...
  unit.exercises.forEach((exercise, idx) => {
    const input = document.getElementById(`ex-${idx}`);
    if (!input) return;
    const userValue = normalize(input.value);
    const answerValue = normalize(exercise.a);
    if (userValue === answerValue) score += 1;
  });

  exerciseFeedback.textContent = `Exercise score: ${score}/${unit.exercises.length}`;
  exerciseFeedback.style.color = score >= 2 ? "#166534" : "#b91c1c";
}
...
function submitQuiz() {
  ...
  const percent = Math.round((score / unit.quiz.length) * 100);
  quizResult.textContent = `Quiz result: ${score}/${unit.quiz.length} (${percent}%)`;
  quizResult.style.color = percent >= 70 ? "#166534" : "#b91c1c";
}
